...
class TestPenalty(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        self.assertEquals(self.empty, PenaltyForScale())
        super().tearDown()
    ...
    def test_add_same_color_thumb_over(self):
        ...
        print(two_thumbover)
        print(expected_two)
        self.assertEquals(one_thumbover, expected_one)
        self.assertEquals(two_thumbover, expected_two)
    ...
    def test_add_transition_thumb_over(self):
        ...
        self.assertEquals(one_thumbover, expected)
    ...
    def test_from_scale(self):
        ...
        print(penalty)
        self.assertEquals(penalty, PenaltyForScale(nb_same_color_after_thumb_at_distance_diatonic={1: {3: 1}},
