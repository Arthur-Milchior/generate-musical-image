...
class TestFingering(unittest.TestCase):
    ...
    def test_pinky(self):
        ...
        self.assertEqual(self.pinky_alone.get_finger(Note("D")), None)
  ...
  add_pinky_side(PianoNote(chromatic=0, diatonic=0, finger=5))""")
    ...
    def test_one_note(self):
        ...
        self.assertEqual(self.octave_interval.get_finger(Note("D")), None)
  ...
  add(PianoNote(chromatic=0, diatonic=0, finger=1))""")
    ...
    def test_two_note(self):
        ...
        self.assertEqual(self.three_notes.get_finger(Note("D")), 2)
