...
class SaxophoneButton:
    ...
    def __init__(self,  svg: str, jay_name: Optional[str], londeix: str, name:Optional[str] = None):
        self.name = name if name else londeix
        self._svg = svg
        self.jay_name = jay_name
        self.londeix = londeix
        buttons.append(self)
        self.index = self.first_free_index
