...
#     @classmethod
#     def make(cls, intervals: Iterable[ChromaticInterval])->Self:
...
#             yield InversionPattern(inversion, self.inversion(interval))
...
#         return ChordPattern.get_patterns_from_chromatic_interval(self.intervals)
