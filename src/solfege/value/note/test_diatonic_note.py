...
from solfege.value.interval.test_diatonic_interval import TestDiatonicInterval
from solfege.value.note.abstract_note import OctaveOutput
from solfege.value.note.note import Note
from solfege.value.note.diatonic_note import *
...
class TestDiatonicNote(TestDiatonicInterval):
    ...
    def test_get_note_name_LILY(self) -> None:
    ...
    def test_get_note_name_FILE_NAME(self) -> None:
    ...
    def test_get_octave_name_LILY(self) -> None:
    ...
    def test_get_octave_name_FILE_NAME(self) -> None:
