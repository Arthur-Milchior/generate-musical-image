...
class Chord_Pattern(Solfege_Pattern):
    ...
    def __init__(self, names, intervals, optional=None):
        ...
        intervals.add((0, 0))
        self.intervalsWithoutFifth = frozenset({SolfegeInterval(chromatic=chromatic, diatonic=diatonic) for chromatic, diatonic in intervals if diatonic!=5})
        self.intervals = frozenset({SolfegeInterval(chromatic=chromatic, diatonic=diatonic) for chromatic, diatonic in intervals})
...
Chord_Pattern(["Half-diminished seventh chord","Half-diminished chord","Minor seventh flat five"],{(3,2),(6,4),(10,6)})
Chord_Pattern(["Augmented seventh chord","seventh augmented fifth chord","seventh sharp five chord"],{(4,2),(8,4),(10,6)})
