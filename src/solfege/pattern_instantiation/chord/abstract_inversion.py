...
class AbstractInversion(AbstractPatternInstantiation[ChordPattern, NoteType, IntervalType, NoteListType, IntervalListType],  Generic[NoteType, IntervalType, NoteListType, IntervalListType]): 
