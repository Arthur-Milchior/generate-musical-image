...
from solfege.pattern_instantiation.inversion.chromatic_identical_inversion import ChromaticIdenticalInversion
from solfege.value.interval.interval import Interval
from solfege.value.note.note import Note
from utils.util import assert_typing


class IdenticalInversion(AbstractIdenticalInversion[Note, Interval], AbstractPairInstantiation[IdentiticalInversionPatterns]):
    
    chromatic_instantiation_type: ClassVar = ChromaticIdenticalInversion