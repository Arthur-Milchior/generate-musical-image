...
# from solfege.chord.chord_pattern import *

# from .set_of_intervals import *
...
#                          {Inversion(0, major_chord), Inversion(1, major_first_inversion), Inversion(2, major_second_inversion)})
