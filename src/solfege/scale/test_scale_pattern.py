...
class TestScalePattern(unittest.TestCase):
    ...
    def test_ne(self):
        ...
        self.assertNotEqual(minor_melodic, ScalePattern[Interval](["Minor melodic"], [2, 1, 2, 2, 2, 2],
                                                                   three_flats, suppress_warning=False))
        self.assertNotEqual(minor_melodic, ScalePattern[Interval](["Minor"], [2, 1, 2, 2, 2, 2, 1],
                                                                   three_flats))
    ...
    def test_eq(self):
        ...
        self.assertEqual(minor_melodic._intervals, [
    ...
    def test_number_of_intervals(self):
        self.assertEqual(minor_melodic.number_of_intervals(), 7)
        self.assertEqual(pentatonic_minor.number_of_intervals(), 5)
