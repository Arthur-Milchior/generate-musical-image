...
class IntervalListToIdenticalInversionPattern(IntervalListToPatterns[InversionPattern, list, IdentiticalInversionPatterns]):
    ...
    _chromatic_recorded_container_type: ClassVar[Type] = IdentiticalInversionPatterns
