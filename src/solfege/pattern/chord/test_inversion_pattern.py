...
class TestInversionPattern(unittest.TestCase):
    ...
    def test_inversion_found(self):
        for inversion in inversions:
            self.assertEqual([inversion], interval_to_inversion.get_patterns_from_interval(inversion.interval_list))
            self.assertEqual([inversion], interval_to_inversion.get_patterns_from_chromatic_interval(inversion.interval_list.get_chromatic()))
