...
major_triad = ChordPattern.make(names=["Major triad"], notation="M",
                           _full_interval_list=[(4, 2), (7, 4)], interval_for_signature=nor_flat_nor_sharp)
minor_triad = ChordPattern.make(names=[ "Minor triad"], notation="m",
                           _full_interval_list=[(3, 2), (7, 4)], interval_for_signature=three_flats)

dominant_seventh_chord = ChordPattern.make(names=["Dominant seventh chord", "major minor seventh chord"], notation="<sup>7</sup>",
                                      _full_interval_list=[(4, 2), (7, 4), (10, 6)], optional_fifth=True,
                                      interval_for_signature=one_flat)


major_seventh_chord = ChordPattern.make(names=["Major seventh chord"], notation="<sup>Δ</sup>",
                                   _full_interval_list=[(4, 2), (7, 4), (11, 6)], optional_fifth=True, interval_for_signature=nor_flat_nor_sharp)
minor_major_seventh_chord = ChordPattern.make(names=["Minor major seventh chord"], notation="m<sup>Δ</sup>",
                                         _full_interval_list=[(3, 2), (7, 4), (11, 6)], optional_fifth=True, interval_for_signature=three_flats)
minor_seven = ChordPattern.make(names=["Minor seventh chord"], notation="-<sup>7</sup>",
                           _full_interval_list=[(3, 2), (7, 4), (10, 6)], optional_fifth=True, interval_for_signature=three_flats)

# augmentation

augmented_triad = ChordPattern.make(names=["Augmented triad"], notation="+",
                               _full_interval_list=[(4, 2), (8, 4)], interval_for_signature=nor_flat_nor_sharp)
diminished_triad = ChordPattern.make(names=["Diminished triad"], notation="-", 
                                _full_interval_list=[(3, 2), (6, 4)], interval_for_signature=five_flats)

augmented_major_seventh_chord = ChordPattern.make(names=["Augmented major seventh chord"], notation="+<sup>Δ7</sup>",
                                             _full_interval_list=[(4, 2), (8, 4), (11, 6)], interval_for_signature=nor_flat_nor_sharp)
diminished_major_seventh_chord = ChordPattern.make(names=["Diminished major seventh chord"], notation="<sup>oM7</sup>",
