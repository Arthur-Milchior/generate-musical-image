...
assert(scale2Pos(majorScale.getIntervals(), Pos(1,1))==[Pos(1,1), Pos(1,3), Pos(1,5), Pos(2,1), Pos(2,3), Pos(2,5), Pos(3,2), Pos(3,3)])
print(scale2Pos(majorScale.getIntervals(),Pos(1,2)))
