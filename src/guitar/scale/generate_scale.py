...
from guitar.position.guitar_position_with_fingers import FingersType, GuitarPositionWithFingers, GuitarPositionWithFingersFrozenList
from guitar.position.set.set_of_guitar_positions import SetOfGuitarPositions, SetOfGuitarPositionsFrozenList
...
class AnkiScaleWithFingersAndString(DataClassWithDefaultArgument):
    ...
    scales: SetOfGuitarPositionsFrozenList
    ...
    def _clean_arguments_for_constructor(cls, args: List, kwargs: Dict):
        ...
        args, kwargs = cls.arg_to_kwargs(args, kwargs, "scales", SetOfGuitarPositionsFrozenList)
        return args, kwargs

    def __post_init__(self):
        assert_typing(self.scales, SetOfGuitarPositionsFrozenList)
