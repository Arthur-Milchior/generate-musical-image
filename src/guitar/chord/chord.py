...
class GuitarChord(SetOfPos):
    ...
    def anki(self):
        ...
        """
        text = ""
        for (number,setOfInterval) in [("1",{ChromaticInterval(0)}),("3",{ChromaticInterval(3),ChromaticInterval(4)}), ("5",{ChromaticInterval(6),ChromaticInterval(7)}), ("n",{ChromaticInterval(9),ChromaticInterval(10),ChromaticInterval(11)})]:
            text +=","
            for i in self.chord:
