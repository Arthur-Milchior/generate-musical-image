...
from instruments.fretted_instrument.chord.transposable.identical_inversion_pattern_to_chords_on_fretted_instrument import IdenticalInversionPatternToItsTransposableChords
