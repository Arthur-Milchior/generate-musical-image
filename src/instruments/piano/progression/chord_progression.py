...
# # from instruments.piano.progression.pattern import NamedIntervalsPattern, ChordProgressionPattern
...
#     def left_lily(self):
#         return self.left_hand.syntax_for_lily()

#     def right_lily(self):
#         return self.right_hand.syntax_for_lily()
...
#         return self.tonic.syntax_for_lily()
