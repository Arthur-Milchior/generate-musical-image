...
# from instruments.piano.scales import fingering
# from instruments.piano.fingering_generation import generate, penalty
# from instruments.piano.scales.generate import \
...
#     #                                                      right_hand_lowest_note=Note.make(3, 2),
...
#     #                                            note=Note.make(3, 2), for_right_hand=False),
#     #                           MissingFingering(scale_pattern=minor_arpeggio,
#     #                                            note=Note.make(3, 2), for_right_hand=True),
#     #                       ])
