...
g6_t = Fingering.make("g6", {octave, overtone, b}, fingering_symbol=FingeringSymbol.T)
...
b6_v = Fingering.make("b6", {overtone, octave, b, a, g, f, e, d}, FingeringSymbol.V)

d7_n = Fingering.make("d7", {overtone, b})
