...
from fretted_instrument.chord.open.chromatic_note_list_and_its_guitar_chords import ChromaticNoteListAndItsGuitarChords
from fretted_instrument.chord.test_guitar_chord import CM, CM_
