...
from fretted_instrument.chord.guitar_chord import Barred, GuitarChord
...
from fretted_instrument.position.string.string import String, StringFrozenList, strings
